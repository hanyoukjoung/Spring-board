				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a href="${pageContext.request.contextPath }/user/join/logoutfreeboard.do"><i class="fa fa-key"></i>로그아웃</a></li>
						</ul>
					</li>
				</ul>
			</div>
...
$(function(){
	$('#btn').click(function(){
		...
		var $frm = $('<form name="loginForm" action="${pageContext.request.contextPath }/user/join/loginCheck1.do" method="POST"/></form>');
